...
const AuthPromptModal = ({
	...
	message = "Sign in or create an account to save, star, preview, and share your forms.",
}) => {
		...
		<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs animate-fadeIn">
			...
			>
				...
				<button
					type="button"
					onClick={onClose}
					className="absolute top-4 right-4 p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full transition duration-150 focus:outline-none"
				>
				...
				<div className="flex flex-col sm:flex-row gap-3">
					...
					<button
						type="button"
						onClick={onClose}
						className="flex-1 inline-flex items-center justify-center px-5 py-2.5 bg-gray-50 hover:bg-gray-100 text-gray-700 border border-gray-200 text-sm font-medium rounded-xl transition duration-150"
					>
						Continue Exploring
					</button>
				</div>
